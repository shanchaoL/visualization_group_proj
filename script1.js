...
// console.log(size)
  ...
  var margin1 = {top: 10, right: 30, bottom: 30, left: 60},
      width = Width - margin1.left - margin1.right,
      height = Height - margin1.top - margin1.bottom;
  ...
  var mouseleave = function(d) {
    ...
    svg1.selectAll("circle").classed("selected", function(d){ return isBrushed(extent, x(d.user_review), y(d.meta_score) ) } )
  }
